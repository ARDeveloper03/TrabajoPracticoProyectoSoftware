...
{     
    ...
    {
        var category1 = new Category(1, "Electrodomesticos");
        var category2 = new Category(2, "Tecnologia y Electronica");
        var category3 = new Category(3, "Moda y Accesorios");
        var category4 = new Category(4, "Hogar y Decoracion");
